 ...
 */
public class TackPictionActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_taskpiction);
        ...
        if (feedList == null) {
            CameraManager.getInst().openCamera(TackPictionActivity.this);
        } else {
            ...
            holder.pictureLayout.getHandler().postDelayed(new Runnable() {
                ...
                public void run() {
                    for (TagItem feedImageTag : holder.getTagList()) {
                        LabelView tagView = new LabelView(TackPictionActivity.this);
