...
public class TouMainActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maintou);
    ...
    private void initView() {
        mVpContent = (ViewPager) findViewById(R.id.vp_contents);
        mBottomBarLayout = (BottomBarLayout) findViewById(R.id.bottombarlay);
    }
