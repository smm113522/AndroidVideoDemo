...
public class Text2SpeechService extends Service {
	...
	private OnCompletionListener onCompletionListener = new OnCompletionListener() {
		...
		public void onCompletion(MediaPlayer mp) {
			Intent intentBroad = new Intent(com.wulee.text2speachlib.Text2Speech.ACTION_TEXT2SPEECH);
			...
			Intent intent = new Intent(com.wulee.text2speachlib.Text2Speech.ACTION_TEXT2SPEECH);
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		tempRoot = getCacheDir() + com.wulee.text2speachlib.Text2Speech.TEXT2SPEECH_TEMP_DIR;
		saveRoot = getCacheDir() + com.wulee.text2speachlib.Text2Speech.TEXT2SPEECH_SAVE_DIR;
		if (intent != null) {
			try {
				if (downHandler == null) {
